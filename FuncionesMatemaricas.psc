Algoritmo FubcionesMatematicas
	Definir ValoresAbs, ParteEntera, Redondear, RaizC, NumX Como Real
	Escribir "Ingresesa el numero a calcular: "
	Leer NumX 
	ValorAbs = abs(NumX)
	...
	Escribir "El numero: " NumX " redondendo es: " Redondear
